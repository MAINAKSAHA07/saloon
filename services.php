...
<html lang="en">
  <head>
    ...
    <title>Shaurozz | service Page </title>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="200" width="400" class="img-responsive about-me">
                    <div class="about-grids ">
                        ...
                        <a href="https://rzp.io/l/Shaurozzsalon" target="blank"> <button type="Button" style="color:aqua;" >Pay Now <?php echo $row['payment'];?> </button>  </a>
